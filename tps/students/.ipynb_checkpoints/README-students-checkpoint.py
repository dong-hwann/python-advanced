...
'''
        for topic in self.grades:
            average_grade = f"{self.compute_average(topic):.2f}"
            report += f"""|{topic.center(15)}|{average_grade.center(15)}|
+---------------+---------------+\n"""
        return report
    
bebert = Student("Albert", "Einstein")
bebert.add_grade("History", 10)
bebert.add_grade("Mathematics", 18.5)
print(bebert.report())
